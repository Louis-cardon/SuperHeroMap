namespace SuperHeroMapApi.Services
{
    ...
    public class SuperHeroService : ISuperHeroService
    {
        ...
        {
            return await _context.SuperHeroes.Include(f=>f.SuperHeroIncidentResources).ThenInclude(f=>f.IncidentResource).Include(f => f.SuperHeroIncidents).ThenInclude(f => f.Incident).ToListAsync();
        }
