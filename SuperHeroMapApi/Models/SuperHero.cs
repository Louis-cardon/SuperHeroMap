...
namespace SuperHeroMapApi.Models
{
    public class SuperHero
    {
        ...
        public ICollection<SuperHeroIncidentResource>? SuperHeroIncidentResources { get; set; } // Collection de références aux SuperHeroIncidentResources associés à ce Super Héros
        public ICollection<SuperHeroIncident>? SuperHeroIncidents { get; set; } // Collection de références aux SuperHeroIncidents associés à ce Super Héros
    }
}
